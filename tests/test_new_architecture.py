"""
Tests for the new functional architecture.

These tests verify the new architecture works without running the full pipeline.
"""
...
from src.rag_scraping.config import load_config, get_output_paths, validate_config
...
from src.rag_scraping.scraping import extract_main_content, extract_associated_files
